...
public class consumer implements Runnable{
	private Context c;
	 ...
	 public consumer(Context _c){
	        ...
	        c=_c;
	        Toast.makeText(c,"consumer constructor", 2).show();
	    }
...
*/
     	    	 ...
     	    	 while (true) {
  						...
  						try {
  							s = (String) q1.take();
  							 ...
  							 Toast.makeText(c,"element from queue : "+s+" num of elements in queqe: "+q1.size(), 2).show();
  							
  						} catch (InterruptedException e) {
  							 Toast.makeText(c,"error queue not emmpty", 2).show();
  							e.printStackTrace();
  						}
    	 ...
    	 Toast.makeText(c,"error consumer main : "+e.getLocalizedMessage(), 3).show();
